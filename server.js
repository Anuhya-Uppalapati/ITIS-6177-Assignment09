...
app.get('/say', (req, res) => {
        if(req.query.keyword){
                let config={url: 'https://41wr2tryda.execute-api.us-east-1.amazonaws.com/default/myFunction?keyword=',
                            queryParams: req.query.keyword}
                axios.get(config.url + config.queryParams)
                .then(resp=>{
                ...
                res.statusCode= 400;
                res.setHeader('Content-Type', 'text/plain');
                res.send('required parameter: keyword=hello');
        }      
});
